...
export default function WebProjectModal({ project, onClose }: { project: 'aventura' | 'kuyak' | 'workline'; onClose: () => void }) {
  ...
  return (
    <AnimatedModal onClose={onClose} borderColor={`${data.color}44`}>
      {(handleClose) => (
        <>
